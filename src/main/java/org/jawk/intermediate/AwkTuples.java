...
public class AwkTuples implements Serializable {
  ...
  private static class AddressImpl implements Address, Serializable {
	private String lbl;
	private int idx=-1;
	private AddressImpl(String lbl) { this.lbl = lbl; }
	public String label() { return lbl; }
	public String toString() { return label(); }
	public void assignIndex(int idx) { this.idx = idx; }
	public int index() {
  ...
  private class PositionImpl implements PositionForInterpretation, PositionForCompilation {
	...
	public boolean isEOF() { return idx >= queue.size(); }
	public void next() {
		assert tuple != null;
		++idx;
		tuple = tuple.next;
	...
	public void jump(Address address) { tuple = queue.get(idx = address.index()); }
	public String toString() { return "["+idx+"]-->"+tuple.toString(); }
	public int opcode() { return tuple.opcode; }
	public int intArg(int arg_idx) {
		Class c = tuple.types[arg_idx];
		if (c == Integer.class) return tuple.ints[arg_idx];
		throw new Error("Invalid arg type: "+c+", arg_idx = "+arg_idx+", tuple = "+tuple);
	}
	public boolean boolArg(int arg_idx) {
		Class c = tuple.types[arg_idx];
		if (c == Boolean.class) return tuple.bools[arg_idx];
		throw new Error("Invalid arg type: "+c+", arg_idx = "+arg_idx+", tuple = "+tuple);
	}
	public Object arg(int arg_idx) {
		Class c = tuple.types[arg_idx];
		if (c == Integer.class) return tuple.ints[arg_idx];
		if (c == Double.class) return tuple.doubles[arg_idx];
		if (c == String.class) return tuple.strings[arg_idx];
		if (c == Address.class) { assert arg_idx == 0; return tuple.address; }
		throw new Error("Invalid arg type: "+c+", arg_idx = "+arg_idx+", tuple = "+tuple);
	}
	...
	public int current() { return idx; }
	public void jump(int idx) { tuple = queue.get(this.idx = idx); }
  }
  ...
  public void pop() { queue.add(new Tuple(_POP_)); }
  ...
  public void ifFalse(Address address) { queue.add(new Tuple(_IFFALSE_, address)); }
  public void toNumber() { queue.add(new Tuple(_TO_NUMBER_)); }
  public void ifTrue(Address address) { queue.add(new Tuple(_IFTRUE_, address)); }
  public void gotoAddress(Address address) { queue.add(new Tuple(_GOTO_, address)); }
  ...
  public void nop() { queue.add(new Tuple(_NOP_)); }
  public void print(int num_exprs) { queue.add(new Tuple(_PRINT_, num_exprs)); }
  public void printToFile(int num_exprs, boolean append) { queue.add(new Tuple(_PRINT_TO_FILE_, num_exprs, append)); }
  public void printToPipe(int num_exprs) { queue.add(new Tuple(_PRINT_TO_PIPE_, num_exprs)); }
  public void printf(int num_exprs) { queue.add(new Tuple(_PRINTF_, num_exprs)); }
  public void printfToFile(int num_exprs, boolean append) { queue.add(new Tuple(_PRINTF_TO_FILE_, num_exprs, append)); }
  public void printfToPipe(int num_exprs) { queue.add(new Tuple(_PRINTF_TO_PIPE_, num_exprs)); }
  public void sprintf(int num_exprs) { queue.add(new Tuple(_SPRINTF_, num_exprs)); }
  public void length(int num_exprs) { queue.add(new Tuple(_LENGTH_, num_exprs)); }
  public void concat() { queue.add(new Tuple(_CONCAT_)); }
  public void assign(int offset, boolean is_global) { queue.add(new Tuple(_ASSIGN_, offset, is_global)); }
  public void assignArray(int offset, boolean is_global) { queue.add(new Tuple(_ASSIGN_ARRAY_, offset, is_global)); }
  public void assignAsInput() { queue.add(new Tuple(_ASSIGN_AS_INPUT_)); }
  public void assignAsInputField() { queue.add(new Tuple(_ASSIGN_AS_INPUT_FIELD_)); }
  public void dereference(int offset, boolean is_array, boolean is_global) { queue.add(new Tuple(_DEREFERENCE_, offset, is_array, is_global)); }
  public void plusEq(int offset, boolean is_global) { queue.add(new Tuple(_PLUS_EQ_, offset, is_global)); }
  public void minusEq(int offset, boolean is_global) { queue.add(new Tuple(_MINUS_EQ_, offset, is_global)); }
  public void multEq(int offset, boolean is_global) { queue.add(new Tuple(_MULT_EQ_, offset, is_global)); }
  public void divEq(int offset, boolean is_global) { queue.add(new Tuple(_DIV_EQ_, offset, is_global)); }
  public void modEq(int offset, boolean is_global) { queue.add(new Tuple(_MOD_EQ_, offset, is_global)); }
  public void powEq(int offset, boolean is_global) { queue.add(new Tuple(_POW_EQ_, offset, is_global)); }
  public void plusEqArray(int offset, boolean is_global) { queue.add(new Tuple(_PLUS_EQ_ARRAY_, offset, is_global)); }
  public void minusEqArray(int offset, boolean is_global) { queue.add(new Tuple(_MINUS_EQ_ARRAY_, offset, is_global)); }
  public void multEqArray(int offset, boolean is_global) { queue.add(new Tuple(_MULT_EQ_ARRAY_, offset, is_global)); }
  public void divEqArray(int offset, boolean is_global) { queue.add(new Tuple(_DIV_EQ_ARRAY_, offset, is_global)); }
  public void modEqArray(int offset, boolean is_global) { queue.add(new Tuple(_MOD_EQ_ARRAY_, offset, is_global)); }
  public void powEqArray(int offset, boolean is_global) { queue.add(new Tuple(_POW_EQ_ARRAY_, offset, is_global)); }
  public void plusEqInputField() { queue.add(new Tuple(_PLUS_EQ_INPUT_FIELD_)); }
  public void minusEqInputField() { queue.add(new Tuple(_MINUS_EQ_INPUT_FIELD_)); }
  public void multEqInputField() { queue.add(new Tuple(_MULT_EQ_INPUT_FIELD_)); }
  public void divEqInputField() { queue.add(new Tuple(_DIV_EQ_INPUT_FIELD_)); }
  public void modEqInputField() { queue.add(new Tuple(_MOD_EQ_INPUT_FIELD_)); }
  public void powEqInputField() { queue.add(new Tuple(_POW_EQ_INPUT_FIELD_)); }

  public void srand(int num) { queue.add(new Tuple(_SRAND_, num)); }
  public void rand() { queue.add(new Tuple(_RAND_)); }
  public void intFunc() { queue.add(new Tuple(_INTFUNC_)); }
  public void sqrt() { queue.add(new Tuple(_SQRT_)); }
  public void log() { queue.add(new Tuple(_LOG_)); }
  public void exp() { queue.add(new Tuple(_EXP_)); }
  public void sin() { queue.add(new Tuple(_SIN_)); }
  public void cos() { queue.add(new Tuple(_COS_)); }
  public void atan2() { queue.add(new Tuple(_ATAN2_)); }
  public void match() { queue.add(new Tuple(_MATCH_)); }
  public void index() { queue.add(new Tuple(_INDEX_)); }
  public void subForDollar0(boolean is_gsub) { queue.add(new Tuple(_SUB_FOR_DOLLAR_0_, is_gsub)); }
  public void subForDollarReference(boolean is_gsub) { queue.add(new Tuple(_SUB_FOR_DOLLAR_REFERENCE_, is_gsub)); }
  public void subForVariable(int offset, boolean is_global, boolean is_gsub) { queue.add(new Tuple(_SUB_FOR_VARIABLE_, offset, is_global, is_gsub)); }
  public void subForArrayReference(int offset, boolean is_global, boolean is_gsub) { queue.add(new Tuple(_SUB_FOR_ARRAY_REFERENCE_, offset, is_global, is_gsub)); }
  public void split(int numargs) { queue.add(new Tuple(_SPLIT_, numargs)); }
  public void substr(int numargs) { queue.add(new Tuple(_SUBSTR_, numargs)); }
  public void tolower() { queue.add(new Tuple(_TOLOWER_)); }
  public void toupper() { queue.add(new Tuple(_TOUPPER_)); }
  public void system() { queue.add(new Tuple(_SYSTEM_)); }
  public void exec() { queue.add(new Tuple(_EXEC_)); }

  public void swap() { queue.add(new Tuple(_SWAP_)); }

  public void add() { queue.add(new Tuple(_ADD_)); }
  public void subtract() { queue.add(new Tuple(_SUBTRACT_)); }
  public void multiply() { queue.add(new Tuple(_MULTIPLY_)); }
  public void divide() { queue.add(new Tuple(_DIVIDE_)); }
  public void mod() { queue.add(new Tuple(_MOD_)); }
  public void pow() { queue.add(new Tuple(_POW_)); }

  public void inc(int offset, boolean is_global) { queue.add(new Tuple(_INC_, offset, is_global)); }
  public void dec(int offset, boolean is_global) { queue.add(new Tuple(_DEC_, offset, is_global)); }
  public void incArrayRef(int offset, boolean is_global) { queue.add(new Tuple(_INC_ARRAY_REF_, offset, is_global)); }
  public void decArrayRef(int offset, boolean is_global) { queue.add(new Tuple(_DEC_ARRAY_REF_, offset, is_global)); }
  public void incDollarRef() { queue.add(new Tuple(_INC_DOLLAR_REF_)); }
  public void decDollarRef() { queue.add(new Tuple(_DEC_DOLLAR_REF_)); }

  public void dup() { queue.add(new Tuple(_DUP_)); }
  public void not() { queue.add(new Tuple(_NOT_)); }
  public void negate() { queue.add(new Tuple(_NEGATE_)); }

  public void cmpEq() { queue.add(new Tuple(_CMP_EQ_)); }
  public void cmpLt() { queue.add(new Tuple(_CMP_LT_)); }
  public void cmpGt() { queue.add(new Tuple(_CMP_GT_)); }
  public void matches() { queue.add(new Tuple(_MATCHES_)); }

  public void sleep(int num_args) { queue.add(new Tuple(_SLEEP_, num_args)); }
  public void dump(int num_args) { queue.add(new Tuple(_DUMP_, num_args)); }

  public void dereferenceArray() { queue.add(new Tuple(_DEREF_ARRAY_)); }

  public void keylist() { queue.add(new Tuple(_KEYLIST_)); }
  public void isEmptyList(Address address) { queue.add(new Tuple(_IS_EMPTY_KEYLIST_, address)); }
  public void getFirstAndRemoveFromList() { queue.add(new Tuple(_GET_FIRST_AND_REMOVE_FROM_KEYLIST_)); }

  public boolean checkClass(Class cls) { queue.add(new Tuple(_CHECK_CLASS_, cls)); return true; }

  public void getInputField() { queue.add(new Tuple(_GET_INPUT_FIELD_)); }

  public void consumeInput(Address address) { queue.add(new Tuple(_CONSUME_INPUT_, address)); }
  public void getlineInput() { queue.add(new Tuple(_GETLINE_INPUT_)); }
  public void useAsFileInput() { queue.add(new Tuple(_USE_AS_FILE_INPUT_)); }
  public void useAsCommandInput() { queue.add(new Tuple(_USE_AS_COMMAND_INPUT_)); }

  public void nfOffset(int offset) { queue.add(new Tuple(_NF_OFFSET_, offset)); }
  public void nrOffset(int offset) { queue.add(new Tuple(_NR_OFFSET_, offset)); }
  public void fnrOffset(int offset) { queue.add(new Tuple(_FNR_OFFSET_, offset)); }
  public void fsOffset(int offset) { queue.add(new Tuple(_FS_OFFSET_, offset)); }
  public void rsOffset(int offset) { queue.add(new Tuple(_RS_OFFSET_, offset)); }
  public void ofsOffset(int offset) { queue.add(new Tuple(_OFS_OFFSET_, offset)); }
  public void rstartOffset(int offset) { queue.add(new Tuple(_RSTART_OFFSET_, offset)); }
  public void rlengthOffset(int offset) { queue.add(new Tuple(_RLENGTH_OFFSET_, offset)); }
  public void filenameOffset(int offset) { queue.add(new Tuple(_FILENAME_OFFSET_, offset)); }
  public void subsepOffset(int offset) { queue.add(new Tuple(_SUBSEP_OFFSET_, offset)); }
  public void convfmtOffset(int offset) { queue.add(new Tuple(_CONVFMT_OFFSET_, offset)); }
  public void ofmtOffset(int offset) { queue.add(new Tuple(_OFMT_OFFSET_, offset)); }
  public void environOffset(int offset) { queue.add(new Tuple(_ENVIRON_OFFSET_, offset)); }
  public void argcOffset(int offset) { queue.add(new Tuple(_ARGC_OFFSET_, offset)); }
  public void argvOffset(int offset) { queue.add(new Tuple(_ARGV_OFFSET_, offset)); }

  public void applyRS() { queue.add(new Tuple(_APPLY_RS_)); }

  public void function(String func_name, int num_formal_params) { queue.add(new Tuple(_FUNCTION_, func_name, num_formal_params)); }
  ...
  public void callFunction(HasFunctionAddress has_func_addr, String func_name, int num_formal_params, int num_actual_params) { queue.add(new Tuple(_CALL_FUNCTION_, has_func_addr, func_name, num_formal_params, num_actual_params)); }
  public void setReturnResult() { queue.add(new Tuple(_SET_RETURN_RESULT_)); }
  public void returnFromFunction() { queue.add(new Tuple(_RETURN_FROM_FUNCTION_)); }

  public void setNumGlobals(int num_globals) { queue.add(new Tuple(_SET_NUM_GLOBALS_, num_globals)); }

  public void close() { queue.add(new Tuple(_CLOSE_)); }

  public void applySubsep(int count) { queue.add(new Tuple(_APPLY_SUBSEP_, count)); }

  public void deleteArrayElement(int offset, boolean is_global) { queue.add(new Tuple(_DELETE_ARRAY_ELEMENT_, offset, is_global)); }
  public void deleteArray(int offset, boolean is_global) { queue.add(new Tuple(_DELETE_ARRAY_, offset, is_global)); }

  public void setExitAddress(Address addr) { queue.add(new Tuple(_SET_EXIT_ADDRESS_, addr)); }
  public void setWithinEndBlocks(boolean b) { queue.add(new Tuple(_SET_WITHIN_END_BLOCKS_, b)); }
  public void exitWithCode() { queue.add(new Tuple(_EXIT_WITH_CODE_)); }

  public void regexp(String regexp_str) { queue.add(new Tuple(_REGEXP_, regexp_str)); }
  public void regexpPair() { queue.add(new Tuple(_REGEXP_PAIR_)); }

  public void isIn() { queue.add(new Tuple(_IS_IN_)); }

  public void castInt() { queue.add(new Tuple(_CAST_INT_)); }
  public void castDouble() { queue.add(new Tuple(_CAST_DOUBLE_)); }
  public void castString() { queue.add(new Tuple(_CAST_STRING_)); }
  public void scriptThis() { queue.add(new Tuple(_THIS_)); }

  public void extension(String extension_keyword, int param_count, boolean is_initial) { queue.add(new Tuple(_EXTENSION_, extension_keyword, param_count, is_initial)); }
  ...
  public Position top() { return new PositionImpl(); }
  ...
  public Map<String,Integer> getGlobalVariableOffsetMap() { return global_var_offset_map; }
  public Map<String,Boolean> getGlobalVariableAarrayMap() { return global_var_aarray_map; }
